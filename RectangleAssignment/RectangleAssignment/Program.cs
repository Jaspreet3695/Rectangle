    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (selection != 7)
            {
                ...
                switch (selection)
                {
                    case 1: Console.WriteLine("Length is {0} unit(s).", r.GetLength());
                        break;

                    case 2: result = ValidateUserInput("length");
                        r.SetLength(result);
                        break;
                    ...
                    case 6:
                        ...
                        break;
                    default: Console.WriteLine("Please enter a valid input from the menu");
                        break;
                }
